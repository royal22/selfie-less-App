		...
		if s.status_code == 500:
			...
			for i in range(1,len(y)):
				...
				if(int(port.group(0)[1:]) == 8000):
					...
					#serial.write('\x01')
					#os.system('c')
					os.system(" sudo docker run -d -p 8000:80 -v /home/hduser/Desktop/assignment4/database1:/data acts")
					time.sleep(1)
					break
				...
				if s.status_code == 500:
					...
					for j in range(1,len(y)):
						...
						if(int(port.group(0)[1:]) == i):
							...
							os.system("sudo docker run -d -p {}:80 -v /home/hduser/Desktop/assignment4/database1:/data acts".format(i))
							time.sleep(1)
							break	
